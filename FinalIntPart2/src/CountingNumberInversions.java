...
public class CountingNumberInversions {
	...
	int mergeSort(int arr[],int temp[], int left, int right){
		...
		if(right > left){
			...
			//System.out.println("Left value " + left + " Right val " + mid + " Inversion count " +inv_count);
	...
	public static void main(String[] args){
		CountingNumberInversions obj = new CountingNumberInversions();
		 //int arr[] = {1, 20, 6, 4, 5};
		 int arr[] = {4, 2, 3, 5, 1};
