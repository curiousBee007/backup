...
/*public class CorrelatedLearningNewJava {

}*/

/*public class CorrelatedQExample {
...
public class CorrelatedLearningNewBurlap {
	//grid game domain generator
		...
		// public static File file = new File("/Users/Anna/Documents/workspace/ReinforcementLearning/src/MaxQResultVersion1");
		...
		public CorrelatedLearningNewBurlap(){
           ...
           //This is SGAgent type both agents are the same type in grid games with the same action set available
		...
		public void MAQLearning(){
			...
			ValueFunctionInitialization valueFuninit = new ValueFunctionInitialization.ConstantValueFunctionInitialization(25.0);
		
			MultiAgentQLearning a0 = new MultiAgentQLearning(this.domain, this.discount, this.lr, 
					   this.hashingFactory, valueFuninit, new CorrelatedQ(
								CorrelatedEquilibriumObjective.UTILITARIAN), false);
           ...
           /* EGreedyMaxWellfare greedyMaxObj0 = new EGreedyMaxWellfare(epsilon);
            
			EGreedyMaxWellfare greedyMaxObj1 = new EGreedyMaxWellfare(epsilon);*/
			
			ECorrelatedQJointPolicy greedyMaxObj0 = new ECorrelatedQJointPolicy(CorrelatedEquilibriumObjective.UTILITARIAN,epsilon);
			ECorrelatedQJointPolicy greedyMaxObj1 = new ECorrelatedQJointPolicy(CorrelatedEquilibriumObjective.UTILITARIAN,epsilon);
			
		    a0.setLearningPolicy(new PolicyFromJointPolicy(a0.getAgentName(), greedyMaxObj0));
		    
			a1.setLearningPolicy(new PolicyFromJointPolicy(a1.getAgentName(),greedyMaxObj1));
			...
			for(int i = 0; i < ngames; i++){
				...
				ga.writeToFile(String.format("sgTests25/%4d", i));
			}
		...
		public static class  WorldObs implements WorldObserver{
			...
			//This function is adding all action to our joint model
			...
			public void gameEnding(State s) {
				...
				try {
					   File file = new File("/Users/Anna/Documents/workspace/ReinforcementLearning/src/CorrelatedQAgent0Val");
					   File file1 = new File("/Users/Anna/Documents/workspace/ReinforcementLearning/src/CorrelatedQAgent1Val");
		...
		public static void main(String[] args) {
			...
			CorrelatedLearningNewBurlap esg = new CorrelatedLearningNewBurlap();
