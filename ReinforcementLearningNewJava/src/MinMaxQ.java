...
public class MinMaxQ {
	...
	public void MinMaxLearning(){
		...
		MultiAgentQLearning a0 = new MultiAgentQLearning(this.domain, this.discount, this.lr, 
				   this.hashingFactory, valueFuninit, new MinMaxQ(), true);
	...
	public static class  WorldObs implements WorldObserver{
		...
		public void gameEnding(State s) {
			...
			try {
				   File file = new File("/Users/Anna/Documents/workspace/ReinforcementLearningNewJava/src/MinMaxQ0Val");
				   File file1 = new File("/Users/Anna/Documents/workspace/ReinforcementLearningNewJava/src/MinMaxQ1Val");
