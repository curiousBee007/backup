...
public class TemporalLambda {
	...
	Environment env;
	  ...
	  public TemporalLambda(double probToState1, double[] valueEstimates, double[] rewards,double lambda) {
        // add your code here
...
//ValueFunction Initialization
 ...
 public static class RF implements RewardFunction {
  ...
  public double findingFinalVal(double[] rewards, double[] initVal, double prob, double lambda){
	  ...
	  TemporalLambda obj ;
      obj = new TemporalLambda(prob,initVal,rewards,lambda);
    ...
    double rewards[]= {3.9,1.1,-4.5,0.0,2.4,3.3,-1.6}  ;
		...
		double prob =  0.50;
		 ...
		 obj = new TemporalLambda(prob,initValue,rewards,1.0);
		 double finalVal1 = obj.findingFinalVal(rewards,initValue, prob,1.0);
		 System.out.println("Lambda value 1.0  " +"  Final value  "+finalVal1);
		 System.out.println();
		 
		 
		 obj = new TemporalLambda(prob,initValue,rewards,0.605);
		 double finalVal2 = obj.findingFinalVal(rewards,initValue, prob,0.605);
		 System.out.println("Lambda value 0.605  " +"  Final value  "+finalVal2);
		 System.out.println();
		...
		/* for (int i = 0; i< 11;i++){
		 ...
		 obj = new TemporalLambda(prob,initValue,rewards,lambda1);
		 
         double finalVal = obj.findingFinalVal(rewards,initValue, prob,lambda1);

         System.out.println("Lambda value   "+lambda1 +"  Final value  "+finalVal);
