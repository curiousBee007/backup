	...
	//grid game domain generator
		...
		public void MAQLearning(){
           ...
           /* EGreedyMaxWellfare greedyMaxObj0 = new EGreedyMaxWellfare(epsilon);
			...
			ECorrelatedQJointPolicy greedyMaxObj0 = new ECorrelatedQJointPolicy(CorrelatedEquilibriumObjective.EGALITARIAN,epsilon);
			ECorrelatedQJointPolicy greedyMaxObj1 = new ECorrelatedQJointPolicy(CorrelatedEquilibriumObjective.EGALITARIAN,epsilon);
		...
		public static void main(String[] args) {
			...
			CorrelatedQExample esg = new CorrelatedQExample();
