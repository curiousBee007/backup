 ...
 *
 */
public class GridGameOriginal implements DomainGenerator {
	...
	public static void main(String [] args){
		...
		GridGameOriginal gg = new GridGameOriginal();
		...
		*/
		...
		State s = GridGameOriginal.getTurkeyInitialState(d);
	...
	public static State getSimpleGameInitialState(Domain d){
		State s = GridGameOriginal.getCleanState(d, 2, 2, 2, 2, 3, 3);

		GridGameOriginal.setAgent(s, 0, 0, 0, 0);
		GridGameOriginal.setAgent(s, 1, 2, 0, 1);

		GridGameOriginal.setGoal(s, 0, 0, 2, 1);
		GridGameOriginal.setGoal(s, 1, 2, 2, 2);
	...
	public static State getCorrdinationGameInitialState(Domain d){
		...
		GridGameOriginal.setGoal(s, 0, 0, 2, 2);
		GridGameOriginal.setGoal(s, 1, 2, 2, 1);
	...
	public static State getPrisonersDilemmaInitialState(Domain d){
		State s = GridGameOriginal.getCleanState(d, 2, 3, 2, 2, 9, 1);
		
		GridGameOriginal.setAgent(s, 0, 3, 0, 0);
		GridGameOriginal.setAgent(s, 1, 5, 0, 1);
		
		GridGameOriginal.setGoal(s, 0, 0, 0, 1);
		GridGameOriginal.setGoal(s, 1, 4, 0, 0);
		GridGameOriginal.setGoal(s, 2, 8, 0, 2);
	...
	public static State getFriendFoeInitialState(Domain d){
		...
		State s = GridGameOriginal.getCleanState(d, 2, 2, 2, 2, 8, 1);
		
		GridGameOriginal.setAgent(s, 0, 3, 0, 0);
		GridGameOriginal.setAgent(s, 1, 6, 0, 1);
	...
	public static State getIncredibleInitialState(Domain d){
		...
		State s = GridGameOriginal.getCleanState(d, 2, 2, 2, 2, 4, 1);
		
		GridGameOriginal.setAgent(s, 0, 2, 0, 0);
		GridGameOriginal.setAgent(s, 1, 3, 0, 1);
		
		GridGameOriginal.setGoal(s, 0, 0, 0, 1);
		GridGameOriginal.setGoal(s, 1, 1, 0, 2);
	...
	public static State getTurkeyInitialState(Domain d){
		...
		State s = GridGameOriginal.getCleanState(d, 2, 3, 4, 2, 3, 4);
		
		GridGameOriginal.setHorizontalWall(s, 2, 1, 0, 0, 1);
		GridGameOriginal.setHorizontalWall(s, 3, 1, 2, 2, 1);
		
		GridGameOriginal.setAgent(s, 0, 0, 0, 0);
		GridGameOriginal.setAgent(s, 1, 2, 0, 1);
		
		GridGameOriginal.setGoal(s, 0, 0, 3, 1);
		GridGameOriginal.setGoal(s, 1, 1, 2, 0);
		GridGameOriginal.setGoal(s, 2, 2, 3, 2);
	...
	public static SGAgentType getStandardGridGameAgentType(Domain domain){
		return new SGAgentType(GridGameOriginal.CLASSAGENT, domain.getObjectClass(GridGameOriginal.CLASSAGENT), domain.getAgentActions());
	}
	...
	public static class GGJointRewardFunction implements JointReward {
		...
		public GGJointRewardFunction(Domain ggDomain){
			agentInPersonalGoal = ggDomain.getPropFunction(GridGameOriginal.PFINPGOAL);
			agentInUniversalGoal = ggDomain.getPropFunction(GridGameOriginal.PFINUGOAL);
		}
		...
		public Map<String, Double> reward(State s, JointAction ja, State sp) {
			...
			List <ObjectInstance> obs = sp.getObjectsOfClass(GridGameOriginal.CLASSAGENT);
		...
		protected double defaultCost(String aname, JointAction ja){
			...
			else if(ja.action(aname).action.actionName.equals(GridGameOriginal.ACTIONNOOP)){
				return 0.;
			}
			return this.stepCost;
		}
		...
		protected double getPersonalGoalReward(State s, String agentName){
			...
			int pn = s.getObject(agentName).getIntValForAttribute(GridGameOriginal.ATTPN);
