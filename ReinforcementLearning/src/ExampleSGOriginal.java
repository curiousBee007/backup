...
/*public class ExampleSGOriginal {
...
public class ExampleSGOriginal {
	...
	public static void main(String[] args) {
		...
		ExampleSGOriginal esg = new ExampleSGOriginal();
	...
	public ExampleSGOriginal(){
		...
		this.at = new SGAgentType(GridGame.CLASSAGENT, domain.getObjectClass(GridGame.CLASSAGENT), domain.getAgentActions());

		this.w = new World(domain, this.rf, new GridGame.GGTerminalFunction(this.domain),
	...
	/*public void MAValueIteration(){
		...
		burlap.behavior.stochasticgames.madynamicprogramming.dpplanners.MAValueIteration vi = new burlap.behavior.stochasticgames.madynamicprogramming.dpplanners.MAValueIteration(domain, rf, tf, this.discount, hashingFactory, 0., new CoCoQ(), 0.00015, 50);
		...
		MultiAgentDPPlanningAgent a0 = new MultiAgentVFPlanningAgent(domain, vi, new PolicyFromJointPolicy(ja0));
