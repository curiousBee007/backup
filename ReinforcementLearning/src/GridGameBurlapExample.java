 ...
 *
 */
public class GridGameBurlapExample implements DomainGenerator {
	...
	public static void main(String [] args){
		...
		GridGameBurlapExample gg = new GridGameBurlapExample();
		...
		*/
		...
		State s = GridGameBurlapExample.getTurkeyInitialState(d);
	...
	public static State getSimpleGameInitialState(Domain d){
		State s = GridGameBurlapExample.getCleanState(d, 2, 2, 2, 2, 3, 3);

		GridGameBurlapExample.setAgent(s, 0, 0, 0, 0);
		GridGameBurlapExample.setAgent(s, 1, 2, 0, 1);

		GridGameBurlapExample.setGoal(s, 0, 0, 2, 1);
		GridGameBurlapExample.setGoal(s, 1, 2, 2, 2);
	...
	public static State getCorrdinationGameInitialState(Domain d){
		...
		GridGameBurlapExample.setGoal(s, 0, 0, 2, 2);
		GridGameBurlapExample.setGoal(s, 1, 2, 2, 1);
	...
	public static State getPrisonersDilemmaInitialState(Domain d){
		State s = GridGameBurlapExample.getCleanState(d, 2, 3, 2, 2, 9, 1);
		
		GridGameBurlapExample.setAgent(s, 0, 3, 0, 0);
		GridGameBurlapExample.setAgent(s, 1, 5, 0, 1);
		
		GridGameBurlapExample.setGoal(s, 0, 0, 0, 1);
		GridGameBurlapExample.setGoal(s, 1, 4, 0, 0);
		GridGameBurlapExample.setGoal(s, 2, 8, 0, 2);
	...
	public static State getFriendFoeInitialState(Domain d){
		...
		State s = GridGameBurlapExample.getCleanState(d, 2, 2, 2, 2, 8, 1);
		
		GridGameBurlapExample.setAgent(s, 0, 3, 0, 0);
		GridGameBurlapExample.setAgent(s, 1, 6, 0, 1);
	...
	public static State getIncredibleInitialState(Domain d){
		...
		State s = GridGameBurlapExample.getCleanState(d, 2, 2, 2, 2, 4, 1);
		
		GridGameBurlapExample.setAgent(s, 0, 2, 0, 0);
		GridGameBurlapExample.setAgent(s, 1, 3, 0, 1);
		
		GridGameBurlapExample.setGoal(s, 0, 0, 0, 1);
		GridGameBurlapExample.setGoal(s, 1, 1, 0, 2);
	...
	public static State getTurkeyInitialState(Domain d){
		...
		State s = GridGameBurlapExample.getCleanState(d, 2, 3, 4, 2, 3, 4);
		
		GridGameBurlapExample.setHorizontalWall(s, 2, 1, 0, 0, 1);
		GridGameBurlapExample.setHorizontalWall(s, 3, 1, 2, 2, 1);
		
		GridGameBurlapExample.setAgent(s, 0, 0, 0, 0);
		GridGameBurlapExample.setAgent(s, 1, 2, 0, 1);
		
		GridGameBurlapExample.setGoal(s, 0, 0, 3, 1);
		GridGameBurlapExample.setGoal(s, 1, 1, 2, 0);
		GridGameBurlapExample.setGoal(s, 2, 2, 3, 2);
	...
	public static SGAgentType getStandardGridGameAgentType(Domain domain){
		return new SGAgentType(GridGameBurlapExample.CLASSAGENT, domain.getObjectClass(GridGameBurlapExample.CLASSAGENT), domain.getAgentActions());
	}
	...
	public static class GGJointRewardFunction implements JointReward {
		...
		public GGJointRewardFunction(Domain ggDomain){
			agentInPersonalGoal = ggDomain.getPropFunction(GridGameBurlapExample.PFINPGOAL);
			agentInUniversalGoal = ggDomain.getPropFunction(GridGameBurlapExample.PFINUGOAL);
		}
		...
		public Map<String, Double> reward(State s, JointAction ja, State sp) {
			...
			List <ObjectInstance> obs = sp.getObjectsOfClass(GridGameBurlapExample.CLASSAGENT);
		...
		protected double defaultCost(String aname, JointAction ja){
			...
			else if(ja.action(aname).action.actionName.equals(GridGameBurlapExample.ACTIONNOOP)){
				return 0.;
			}
			return this.stepCost;
		}
		...
		protected double getPersonalGoalReward(State s, String agentName){
			...
			int pn = s.getObject(agentName).getIntValForAttribute(GridGameBurlapExample.ATTPN);
