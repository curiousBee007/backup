...
public class FirstMDPProblem {
    ...
    public FirstMDPProblem(double p1, double p2, double p3, double p4) {
        this.numStates = 6;
    ...
    /*public static class EnvironmentLambda implements Environment{
	...
	public static void main(String[] args) {
		...
		double p3 = 3.;
		double p4 = 7.;
		FirstMDPProblem mdp = new FirstMDPProblem(p1,p2,p3,p4);
