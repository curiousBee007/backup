...
public class ContainsCloseNums {
   ...
   /*Logic is to have two maps : map which contains string to pattern and pattern to string*/
	boolean areFollowingPatterns(String[] strings, String[] patterns) {
	    ...
	    for(int i = 0 ; i < strings.length; i++){
	        if(stringPattern.containsKey(strings[i])){
	            ...
	            String givenPattern = patterns[i];
                if(!ch.equals(givenPattern))
                    return false;
...
public static void main(String[] args){
	...
	boolean val1 = obj.areFollowingPatterns(str1, pattern1);
