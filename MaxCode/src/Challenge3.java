...
public class Challenge3 {
	...
	public static boolean isCryptSolution(String[] crypt, char[][] solution) {
	    ...
	    String firstWord = crypt[0];
	    String secondWord = crypt[1];
	    String thirdWord = crypt[2];
	    ...
	    for(int i = 0 ; i < firstWord.length(); i++){
	        ...
	        char ch = map.get(temp);
	        
	        if(i == 0 && ch == '0' && firstWord.length() > 1 )
	            return false;
	    ...
	    for(int i = 0 ; i < secondWord.length(); i++){
	        ...
	        if(i == 0 && ch == '0' && secondWord.length() > 1)
	            return false;
	    ...
	    int firstVal = Integer.parseInt(sb.toString());
	    int secondVal = Integer.parseInt(sb1.toString());
	    int sum = firstVal + secondVal;
	    
	    int thirdVal = Integer.parseInt(sb2.toString());
	    if(sum == thirdVal)
	        return true;
	...
	public static void main(String[] args){
		...
		boolean flag = isCryptSolution(crypt,val);
